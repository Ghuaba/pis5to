        ...
        <main className="min-h-screen flex flex-col justify-center items-center">
            ...
            <form className="my-8" onSubmit={handleSubmit(req)} >
                ...
                <div className="max-w-sm my-4">
                    ...
                    <input type='email' name='email' id='email' {...register('email')} className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" />
                ...
                <div className="max-w-sm my-4">
                    ...
                    <input type='password' name='password' id='password' {...register('password')} className="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" />
                    <span className="block text-red-500 text-xs pl-1 min-h-5">
                        {errors.password?.message}
                    </span>
                </div>
                <div className='my-6'>
                    <button className="btn relative border block w-full font-medium border-gray-200 inline-flex items-center justify-start overflow-hidden transition-all rounded-lg text-sm hover:bg-white group py-3 px-4">
                        ...
                        <span className="relative w-full text-center transition-colors duration-300 ease-in-out group-hover:text-white">Sign in</span>
                    </button>
                </div>
            </form>
        </main>
